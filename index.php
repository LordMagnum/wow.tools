<?php require_once("inc/header.php"); ?>
		<div class='container-fluid'>
			...
			<p>
				WoW.tools is a collection of several tools that interact with/display data from World of Warcraft. 
				Please keep in mind these tools are meant for those with basic technical/datamining skills. 
				For the basics on datamining, check out <a href='https://docs.google.com/document/d/1y1fHaZ1PrLvUTNM8crz081b4t8_pXjOYPxnagc-Y94c/' target='_blank'>this Google doc</a>.
			</p>
			...
			<div class='row'>
				<div class='col-md-4'>
					...
					<table class='table table-condensed table-striped table-hover fptable' style='width: 100%'>
						...
						<thead>
							<tr>
								<th>Description <small style='float: right'>Updates every 5 minutes, last updated <?=$updatedago?> seconds ago</small></th>
				...
				<div class='col-md-4'>
					...
					<table class='table table-condensed table-striped table-hover fptable' style='width: 100%'>
						<thead>
							<tr>
								<th style='min-width: 70px;'>Push ID</th>
								<th>Tables</th>
